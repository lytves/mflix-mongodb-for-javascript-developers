...
;(async () => {
  try {
    ...
    const host = "mongodb+srv://m220student:<MY_SUPER_SECRET_PASSWORD>@mflix-<MY_SUPER_SECRET_HOST>.mongodb.net/test?retryWrites=true"
    ...
    // RESOLVED - TODO: Create the proper predicate and projection
    ...
    // RESOLVED - TODO: Complete the BulkWrite statement below
